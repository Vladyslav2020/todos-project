        ...
        <div className = 'd-flex justify-content-center mt-3'>
            <div className="card text-center" style={{width: '25rem'}}>
                <div className="card-body">
                    ...
                    <br/>This application uses the following technologies: <strong>React JS</strong>, <strong>Redux</strong>,&nbsp;
                    <strong>MySQL</strong>, <strong>Java Spring Framework</strong>.</p></h5>
